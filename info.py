...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002434252806').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002361280046') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002434252806')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://autofilterbot17:WADTMgps3r8BVCcG@cluster0.xt2sa.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "autofilterbot17")
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'anylinks.in')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '73890f1a387de869bf49d466482d83ea1424caeb')
